const teamData = [
  // Hill Family Fellows (2025, 2024, etc.)
  {
    ...
    description: 'Roman Arreguin is a third-year Computer Information Systems major and as a Part-Time Student Operations Manager for both the Student Security Operations Center (SOC) as well as at the Mitchell C. Hill Student-Run Data Center (SDC), is a part of the Hill Family Fellows. In this role, he helps operate the SIEM system within the SOC with the ultimate goal of protecting and supporting the SDC. Through this role, Roman has developed hands-on skills using professional-grade security tools in a real-world environment with tools such as Splunk and Proxmox. After graduation, he plans to work as a security/SOC analyst.',
    picture: 'https://www.cpp.edu/cba/digital-innovation/img/roman_arreguin_headshot.jpg',
    media: {
  ...
  },
  {
    ...
    role: 'Student Operations Manager',
    description: 'Manages the underlying infrastructure used to provide clubs and classrooms compute power that supports student learning. Prior to this position, competed in cybersecurity competitions such as CPTC and CCDC. Plans to pursue a career in consulting, either offensive or defensive.',
    picture: 'https://www.cpp.edu/cba/digital-innovation/img/marshall-j-ung.jpg',
    media: {
  ...
  },
  {
    ...
    program: 'Computer Information Systems',
    role: 'Student Operations Manager',
    description: 'Manages infrastructure projects, explores information technology, and contributes to the organization\'s growth. Enjoys gaining hands-on experience with virtualization, server management, and enterprise security information event management software that are rarely accessible in traditional classroom settings. Plans to pursue a career in networking.',
