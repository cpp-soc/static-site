  ...
  return (
    ...
    >
      <div className="container mx-auto">
        ...
        >
          <a href="/contact" className="text-white hover:text-blue-400 transition duration-300 font-medium border-b border-transparent hover:border-blue-400 pb-1 flex items-center space-x-2">
          ...
          <a href="/faq" className="text-white hover:text-blue-400 transition duration-300 font-medium border-b border-transparent hover:border-blue-400 pb-1 flex items-center space-x-2">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
